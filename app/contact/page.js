...
const fields = [
    { label: "お名前", required: true, type: "text" },
    { label: "フリガナ", required: true, type: "text" },
    { label: "メールアドレス", required: true, type: "email" },
    { label: "会社名", required: true, type: "text" },
    { label: "市区町村・番地", required: false, type: "text" },
    { label: "電話番号", required: false, type: "text" },
    { label: "FAX番号", required: false, type: "text" },
];
export default function Contact() {
        ...
        <>
            ...
            <section className="w-full max-w-490 mx-auto px-4 md:px-6 xl:px-0 py-5">
                ...
                <div className="text-center">
                    <h2
                        className="
                noto-serif-jp font-bold tracking-[0.1em] text-[#1A3263]
                text-[24px]
                md:text-[32px]
                xl:text-[36px]
                2xl:text-[40px]
            ...
            "
                ...
                <div
                    className="
            mx-auto
            mt-10 md:mt-14 xl:mt-16 2xl:mt-20
        ...
        "
            ...
            "
                    >
                        <li>
                            ・
                            <span className="ml-2 md:ml-6 xl:ml-12 2xl:ml-24">
                                がついている項目は必ずご記入ください。
                            </span>
                        </li>
                        ...
                        <li>
                            ・
                            <span className="text-[#6A985E]">
                                個人情報保護方針
                            </span>
                            <span>
                                をご覧いただき、同意のうえご利用ください。
                            </span>
                        </li>
                    </ul>
                </div>
            ...
            <section className="w-full max-w-490 mx-auto bg-white px-8
    md:px-10
    xl:px-16 py-12 md:py-16 xl:py-20 2xl:py-24 px-4">
                <form className="mx-auto w-full max-w-[1560px]">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[180px_80px_1fr] xl:grid-cols-[240px_100px_1fr] 2xl:grid-cols-[300px_120px_1fr] items-start md:items-center border-b border-[#9ECFD7] pb-6 md:pb-8 2xl:pb-10 gap-4 md:gap-0">
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-10 2xl:gap-20">
                            <label className="flex items-center gap-3 2xl:gap-4 noto-jp text-[16px] md:text-[18px] 2xl:text-[20px] leading-[24px] tracking-[-0.042em] text-[#333333]">
                                <input type="radio" name="type" className="h-[16px] w-[16px] 2xl:h-[18px] 2xl:w-[18px]" />
                                採用について
                            </label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[180px_80px_1fr] xl:grid-cols-[240px_100px_1fr] 2xl:grid-cols-[300px_120px_1fr] items-start md:items-center border-b border-[#9ECFD7] py-6 md:py-8 2xl:py-10 gap-3 md:gap-0">
                        ...
                        <div className="flex flex-wrap items-center gap-3 md:gap-4 2xl:gap-5">
                            <span className="noto-jp text-[16px] md:text-[18px] 2xl:text-[20px] text-[#333333]">〒</span>
                            <input className="h-[50px] md:h-[56px] 2xl:h-[60px] w-[75px] 2xl:w-[85px] rounded-[4px] border border-[#707070] px-3 outline-none" />
                            <span>-</span>
                            <input className="h-[50px] md:h-[56px] 2xl:h-[60px] w-[105px] 2xl:w-[120px] rounded-[4px] border border-[#707070] px-3 outline-none" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[180px_80px_1fr] xl:grid-cols-[240px_100px_1fr] 2xl:grid-cols-[300px_120px_1fr] items-start md:items-center border-b border-[#9ECFD7] py-6 md:py-8 2xl:py-10 gap-3 md:gap-0">
                        ...
                        <select className="h-[44px] 2xl:h-[48px] w-[170px] 2xl:w-[190px] rounded-none border border-[#707070] bg-white px-3 outline-none" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-[180px_80px_1fr] xl:grid-cols-[240px_100px_1fr] 2xl:grid-cols-[300px_120px_1fr] items-start border-b border-[#9ECFD7] py-6 md:py-8 2xl:py-10 gap-3 md:gap-0">
                        ...
                        <textarea className="h-[180px] md:h-[220px] 2xl:h-[260px] w-full rounded-none border border-[#707070] p-4 2xl:p-5 outline-none" />
                    </div>
            ...
            <section className="relative w-full max-w-490 mx-auto overflow-hidden px-4 2xl:px-0">
  ...
  <div className="flex justify-center py-10 md:py-12 2xl:py-16">
    <button className="flex h-[76px] w-[310px] md:h-[92px] md:w-[410px] 2xl:h-[118px] 2xl:w-[513px] items-center justify-between rounded-full bg-[#1CA8CB] pl-8 md:pl-12 2xl:pl-[65px] pr-4 md:pr-5 2xl:pr-[27px] shadow-[0px_4px_4px_0px_#00000040]">
